	...
	<div  id="floatingbar">
		 <ul>
		  <li><img border=0 src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/code3/img/hosts.png"></img></li>
		   ...
		   <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/code3/index.php/maincontroller/create_so"><button>+ Distribuição</button></a></li>
...
<div id="container">
	...
	<?php
		echo '<br><table><thead><th>Editar</th><th>Logo</th><th>Distribuição</th></tr></thead>';
	 	
		foreach($query as $a){
		
		echo '<tr><td id="celula1"> <a href= "http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/edit_so/'.$a->id_so.'"><img src="http://metalib.wisconsin.edu/UWMAX/icon_eng/v-icon-edit.png" border=0></a> </td><td id="celula1"><img align="" src="http://hosts2.ad2.com.br/img/'.$a->peq_img.'" border=0></td><td id="celula2"> <a href="http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/show_so2/'.$a->id_so.'">'.$a->so.'</a></td></tr>';
