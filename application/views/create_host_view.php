...
<div id="container">
	...
	<div id="body">
		...
		<?php
			...
			echo form_open('maincontroller/add_host/');
			echo form_fieldset('Criação de host');
			//echo ('Nome do host ');
			//echo form_input('nome_host',set_value('nome_host',$host->nome_host));
			//echo form_error('nome_host');
			//echo '<br>';
			//echo ('Cliente '); 
			//echo form_dropdown('id_cliente',$cliente); 
			...
			<table>
			<tr><td>Cliente</td>	
			<td><?php echo form_dropdown('id_cliente',$cliente,set_value()) ?></td></tr>
			<tr><td>Servidor</td>
			<td><?php echo form_dropdown('id_servidor',$servidor,set_value()) ?></td></tr>
			<tr><td>Distribuição</td>
			<td><?php echo form_dropdown('id_so',$so,set_value()) ?></td></tr>
			<tr><td>Nome do host *</td>
			<td><?php echo form_input('nome_host','','maxlength="30" size="25"') ?></td></tr>
			</table>			
			
			<table>
			<tr><td>Sobrenome *</td>	
			<td><?php echo form_input('sobrenome','','maxlength="30" size="25"') ?></td></tr>
			<tr><td>IP Chegada *</td>
			<td><?php echo form_input('interface_chegada','','maxlength="30" size="25"') ?></td></tr>
			<tr><td>Porta ssh *</td>
			<td><?php echo form_input('porta_ssh','','maxlength="30" size="25"') ?></td></tr>
			<tr><td>Gateway *</td>
			<td><?php echo form_input('gateway','','maxlength="30" size="25"') ?></td></tr>
			</table>

			<table>
			<tr><td>Interface1</td>
			<td><?php echo form_input('if1') ?></td></tr>
			<tr><td>IP1</td>
			<td><?php echo form_input('ip1') ?></td></tr>
			<tr><td>Máscara1</td>
			<td><?php echo form_input('masc1') ?></td></tr>
			<tr><td>Observação1</td>
			<td><?php echo form_input('obs1') ?></td></tr>
			</table>

			<table>
			<tr><td>Interface2</td>
			<td><?php echo form_input('if2') ?></td></tr>
			<tr><td>IP1</td>
			<td><?php echo form_input('ip2') ?></td></tr>
			<tr><td>Máscara1</td>
			<td><?php echo form_input('masc2') ?></td></tr>
			<tr><td>Observação1</td>
			<td><?php echo form_input('obs2') ?></td></tr>
			</table>

			<table>
			<tr><td>Interface3</td>
			<td><?php echo form_input('if3') ?></td></tr>
			<tr><td>IP1</td>
			<td><?php echo form_input('ip3') ?></td></tr>
			<tr><td>Máscara1</td>
			<td><?php echo form_input('masc3') ?></td></tr>
			<tr><td>Observação1</td>
			<td><?php echo form_input('obs3') ?></td></tr>
			</table>

			<table>
			<tr><td>Interface2</td>
			<td><?php echo form_input('if4') ?></td></tr>
			<tr><td>IP1</td>
			<td><?php echo form_input('ip4') ?></td></tr>
			<tr><td>Máscara1</td>
			<td><?php echo form_input('masc4') ?></td></tr>
			<tr><td>Observação1</td>
			<td><?php echo form_input('obs4') ?></td></tr>
			</table>
			...
			echo form_textarea($servico_data) ?></td>
			<td>Rotas</td>
			<td><?php
			$rota_data = array(
	       		'id' => 'rotas',
			...
			echo form_textarea($rota_data);	?></td>
			</tr>
			</table>
			...
			echo form_textarea($obs_gerais_data) ?></td>
			</tr>
			</table>
