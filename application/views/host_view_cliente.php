...
<div id="container">
	<?php echo '<h1>' .$titulo_cliente->cliente. '</h1>' ?>
	
	<div id="body2">
	
	<?php
		//echo'<h1>' .$titulo_cliente->cliente. '</h1>';
		echo '<br><table><thead><th>Editar</th><th>Visualizar</th><th>Servidor</th><th>distribuição</th><th>nome</th><th>ip chegada</th><th>porta</th><th>gateway</th></tr></thead>';
	 	
		foreach($query as $a){
		
		echo '<tr><td id="celula1"> <a href= "http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/edit_host/'.$a->id_host.'"><img src="http://metalib.wisconsin.edu/UWMAX/icon_eng/v-icon-edit.png" border=0></a> </td><td id="celula1"><a href= "http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/detalhes_host/'.$a->id_host.'"><img src="http://png.findicons.com/files/icons/753/gnome_desktop/32/gnome_view_restore.png"></td><td id="celula2">' .$a->servidor. '</td><td id="celula3"><img align="" src="http://hosts2.ad2.com.br/img/'.$a->peq_img.'" border=0> ' .$a->so. '</td><td id="celula3">' .$a->nome_host. '</td><td id="celula2">' .$a->interface_chegada. '</td><td id="celula2">' .$a->porta_ssh. '</td><td id="celula2">' .$a->gateway. '</td></tr>';
