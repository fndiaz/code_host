	...
	<div  id="floatingbar">
		 ...
		 <ul>
		  <li><img border=0 src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/code3/img/hosts.png"></img></li>
		   ...
		   <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/code3/index.php/maincontroller/create_cliente""><button>+ Cliente</button></a></li>
...
<div id="container">
	...
	<?php
		echo '<br><table><thead><th>Editar</th><th>Cliente</th></tr></thead>';
	 	
		foreach($query as $a){
		
		echo '<tr><td id="celula1"> <a href= "http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/edit_usuario/'.$a->id_cliente.'"><img src="http://metalib.wisconsin.edu/UWMAX/icon_eng/v-icon-edit.png" border=0></a> </td><td id="celula2"> <a href="http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/show_host2/'.$a->id_cliente.'">'.$a->cliente.'</a></td></tr>';
