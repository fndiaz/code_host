...
<div id="container_menu">
	...
	<div  id="floatingbar">
		 <ul>
		  ...
		  <li><a href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/code3/index.php/maincontroller/create_servidor"><button>+ Servidor</button></a></li>
...
<div id="container">
	...
	<?php
		echo '<br><table><thead><th>Editar</th><th>Servidor</th></tr></thead>';
	 	
		foreach($query as $a){
		
		echo '<tr><td id="celula1"> <a href= "http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/edit_servidor/'.$a->id_servidor.'"><img src="http://metalib.wisconsin.edu/UWMAX/icon_eng/v-icon-edit.png" border=0></a> </td><td id="celula2"> <a href="http://' .$_SERVER['SERVER_NAME']. '/code3/index.php/maincontroller/show_servidor2/'.$a->id_servidor.'">'.$a->servidor.'</a></td></tr>';
